...
<td><a href="<?php echo $v['caturl'];?>" target="_blank">
<?php //echo $v['catname'];
 if(is_array($v['cates'])) { foreach($v['cates'] as $c) { 
 $catRow = get_cat($c);
?>
<a href="<?php echo $MOD['linkurl'].$catRow['linkurl'];?>" target="_blank"><?php  echo $catRow['catname'];?></a><br />
<?php
 } }
